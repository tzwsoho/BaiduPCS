...
namespace BaiduPCS
{
    public class ListViewSorter : IComparer
    {
        ...
        public ListViewSorter(ListView lvw, int nColumn)
        {
            m_ListView = lvw;
            m_nSortColumn = nColumn;

            lvw.ListViewItemSorter = this;
            if (SortOrder.Descending == lvw.Sorting)
            {
